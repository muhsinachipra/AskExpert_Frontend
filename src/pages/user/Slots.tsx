    ...
    return (
        <>
            ...
            <div className="container mx-auto mt-10 min-h-[100vh]">
                <div className="text-4xl ml-3 md:ml-0 font-bold mb-6">Book an Appointment</div>
                <div className="space-y-4">
                    ...
                    {slotData && slotData.length > 0 ? (
                        ...
                        <div className="pt-5 ml-3 md:ml-0 text-3xl font-bold mb-6">No appointments available</div>
                    )}
                </div>
