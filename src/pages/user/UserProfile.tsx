...
//             <button
//               onClick={() => setActivePage("profile")}
//               className={`p-2 rounded text-left transition-colors ${activePage === "profile" ? "bg-gray-700" : "hover:bg-gray-700"}`}
//             >
//               Profile
//             </button>
//             <button
//               onClick={() => setActivePage("wallet")}
//               className={`p-2 rounded text-left transition-colors ${activePage === "wallet" ? "bg-gray-700" : "hover:bg-gray-700"}`}
//             >
//               Wallet
//             </button>
//           </nav>
